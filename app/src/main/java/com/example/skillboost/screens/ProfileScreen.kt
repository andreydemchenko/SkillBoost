...
import com.example.skillboost.MainActivity
...
@Composable
fun ProfileScreen(mainViewModel: MainViewModel, loginViewModel: LoginViewModel, viewModel: ProfileViewModel) {
    Box(
        modifier = Modifier
            .fillMaxSize()
            .paint(
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                Column(
                    ...
                    if (cards.isEmpty()) {
                        ...
                        CoursersCardList(cards = cards, mainViewModel = mainViewModel, onCardClicked = { cardId ->
